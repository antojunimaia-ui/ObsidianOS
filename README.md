...
> Um sistema operacional completo rodando inteiramente no navegador, construído com React, TypeScript e Vite. Simula fielmente a experiência de um OS moderno — com BIOS real, kernel executável, sistema de arquivos virtual, registro, processos, janelas, BSOD e muito mais.
...
- **BSOD funcional** com memory dump escrito no filesystem virtual
